...
from wisdom.preprocessing.dna.DNAEnums import DiscoveryMode, EvidenceKind
...
class DNADatasetSource:
    ...
    def records(self, context: ProcessingWorkspace) -> Iterable[ProcessingRecord]:
        ...
        is enforced later by :class:`DNAPartitionTask`, after evidence filtering, geometry, local
        annotation, and full-population leakage/phenotype analysis. This source performs no
        structural preprocessing and assigns no WISDOM surface.
    ...
    @staticmethod
    def _unique_records(values: Iterable[Mapping[str, Any]]) -> tuple[ProcessingRecord, ...]:
        ...
        previous : dict[str, ProcessingRecord] = {}
    ...
    @staticmethod
    def _record(value: Mapping[str, Any]) -> ProcessingRecord:
        ...
        if value.get("structure_path"):
            ...
            return ProcessingRecord(key=key, value=dict(value))
        ...
        return ProcessingRecord(key=key, value=dict(value), metadata={"candidate_key": key})
